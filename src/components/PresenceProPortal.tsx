      ...
      <div className="flex items-center justify-between px-6 py-3.5 bg-[#f1f5f9] border-b border-blue-100 text-[#1e3a8a] shadow-sm shrink-0">
        <div className="flex items-center gap-4">
          <Button 
            onClick={onClose} 
            variant="ghost" 
            className="flex items-center gap-2 hover:bg-[#dbeafe] hover:text-[#1e3a8a] text-[#1e3a8a] font-bold transition-all duration-200 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold text-[#1e3a8a] tracking-wide">PresencePro</span>
            <span className="text-[10px] bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-full font-extrabold uppercase">
              Embedded Active
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <a 
            ...
            className="flex items-center gap-1 text-xs text-blue-650 hover:text-[#1e3a8a] transition-colors duration-200"
          >
