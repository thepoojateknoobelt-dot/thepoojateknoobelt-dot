      ...
      <div className="flex items-center justify-between px-6 py-3.5 bg-zinc-900 border-b border-zinc-800 text-zinc-300 shadow-md shrink-0">
        <div className="flex items-center gap-4">
          <Button 
            onClick={onClose} 
            variant="ghost" 
            className="flex items-center gap-2 hover:bg-zinc-800 hover:text-white text-zinc-300 font-bold transition-all duration-200"
          >
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold text-white tracking-wide">Beltcut Pro</span>
